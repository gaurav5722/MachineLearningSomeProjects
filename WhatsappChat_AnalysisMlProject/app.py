...
if uploaded_file is not None:
    ...
    if st.sidebar.button("Show Analysis"):
        ...
        with col1:
            ...
            # busy_day['day_name'].value_counts() <-- it will give the most busy day
            # To print it using bar chart
        ...
        st.pyplot(fig)
        st.text("the dark shade are showing least active and brighter shades are showing most active"
