# it is necessary to make two files one of static and other of template
# static files have images
# templates  has  html,css,javascript in it
# app.py is used for backend and to interact with frontend we use template
# https://en.wikipedia.org/wiki/Jinja_(template_engine)
# The above wikipedia link is for reference
...
#
# # request is used to fulfill request for backend
# # render_template is used to redirect from backend to frontend
# app = Flask(__name__)
#
# # load files ==================================================================================================================================================================================================================================================================================================================
...
#     top_similar_items = str(similar_items[1:top_n+1])
#
...
@app.route("/main")
def main():
    return render_template('main.html',message = "Please search to get the recommendation")
