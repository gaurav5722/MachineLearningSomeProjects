...
@app.route('/ana')
def ana():
    average_satisfaction, department_satisfaction, salary_satisfaction, left_employees, stayed_employees = employee_important_info(
        df)
    #call plot function
    plots(df,'left')
    plots(df,'salary')
    ...
    # converting serires object to dectionary
...
# placement is the route for form input
# To get any request from methods we use this syntax
